...
class _$FlickrTearOff {
  ...
  Flickr fromJson(Map<String, Object> json) {
    return Flickr.fromJson(json);
  }
}
...
class _$_Flickr implements _Flickr {
  ...
  factory _$_Flickr.fromJson(Map<String, dynamic> json) =>
      _$_$_FlickrFromJson(json);
...
abstract class _Flickr implements Flickr {
  factory _Flickr(
      {@JsonKey(name: 'small') List<String>? small,
      @JsonKey(name: 'original') List<String>? original}) = _$_Flickr;

  factory _Flickr.fromJson(Map<String, dynamic> json) = _$_Flickr.fromJson;
